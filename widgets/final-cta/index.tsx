  ...
  return (
    <section className="relative py-24 md:py-36 overflow-hidden hairline-t">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(255,203,71,0.10), rgba(255,203,71,0) 65%)",
        }}
      />
      <div className="relative mx-auto max-w-[1200px] px-6 md:px-10 text-center">
        <span className="eyebrow">Stack / kz · 2026</span>
        <h2 className="huge mt-8">
          Перестань <em className="font-display italic text-[color:var(--gold)]">гадать</em>.
          <br />
          Начни считать.
        </h2>
