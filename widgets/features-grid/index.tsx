...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    body: "Сколько новых вакансий выходит каждый день по твоему стеку. Где рынок перегрет, где простой. Экспорт в CSV и алерты по порогу — встроены.",
    chart: <DemandSpark />,
  },
  {
    tag: "/ companies",
  ...
  },
  {
    ...
    body: "REST-эндпоинты на всю аналитику. CSV/JSON экспорт любого среза до 10K строк. Готовые срезы под HR-тулы и борды.",
    chart: <ApiChart />,
  },
];
